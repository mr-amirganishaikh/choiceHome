                ...
                <div class="container">
                    <div class="col-xs-12 col-sm-6">
                        <div id="carousel-aboutUs" class="carousel slide" data-ride="carousel">
                            ...
                            <i class="carousel-control-right fa fa-angle-right" data-target="#carousel-aboutUs" data-slide="next"></i>
                        </div>
                    </div>   
                            ...
                            <div class="carousel-inner">
                                <div class="item active">
                                    <div class="col-xs-12 col-sm-4">
                                        ...
                                        <div class = "abt-what-text">
                                            <h3>Green Building</h3>
                                            <p>Vivamus ac eros at nisl sagittis ornare. Ut ipsum lacus,  Integer vel nisl et tortor gravida pharetra.</p>
                                        </div>
                                    </div>
                                    <div class="col-xs-12 col-sm-4">
